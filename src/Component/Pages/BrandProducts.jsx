...
const BrandProducts = () => {
    ...
    return (
        <div className="flex justify-center items-center w-[85%] mx-auto gap-[100px]">
            <div className="w-[1/3]">
        ...
        <div className="grid grid-cols-3 gap-[50px] w-[2/3] ">
            {
                products.map(product=><div key={product.id} className="relative">
                    <img src={product.image} alt="" className="w-[500px] h-[400px] rounded-2xl " />
                    <div className="w-[355px] h-[400px] rounded-2xl bg-black opacity-[0.4] absolute top-[1px]"></div>
